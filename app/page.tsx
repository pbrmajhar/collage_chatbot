...
export default function Home() {
  return (
    <main className="h-screen overflow-hidden px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto flex h-full w-full max-w-5xl flex-col overflow-hidden rounded-[1.5rem] border border-white/10 bg-slate- shadow-2xl shadow-black/30 backdrop-blur">
